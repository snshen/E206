...
class Expansive_Planner():
    ...
    def construct_traj(self, initial_state, desired_state, objects, walls, sampling_strategy="random"):
        ...
        self.mean_edge_velocity = self.MEAN_EDGE_VELOCITY
    ...
    def generate_goal_node(self, node, desired_state):
        ...
        """
        distance = self.calculate_edge_distance(desired_state, node)
        desired_state[0] = node.state[0] + (distance / self.mean_edge_velocity)
