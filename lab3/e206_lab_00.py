...
from traj_planner_ExpPlanner import Expansive_Planner
...
def main():
  ...
  desired_traj, traj_length = planner.construct_optimized_traj(current_state, desired_state, objects, walls)
