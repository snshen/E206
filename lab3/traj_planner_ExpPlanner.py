...
if __name__ == '__main__':
  ...
  for i in range(0, 50):
    ...
    traj, traj_cost, mean_duration, num_constructions = planner.construct_optimized_traj(tp0, tp1, objects, walls, mode = 0)
    ...
    # print("naive:", traj_cost, mean_duration, num_constructions)
    # if len(traj) > 0:
    #   plot_traj(traj, traj, objects, walls)
    # print()
    traj, traj_cost, mean_duration, num_constructions = planner.construct_optimized_traj(tp0, tp1, objects, walls, mode = 1)
    if (traj_cost < planner.LARGE_NUMBER):
      weighted_cost.append(traj_cost)
      weighted_count.append(num_constructions)
    else:
      print("exceeded expected runtime to build traj")
    # print("weighted:", traj_cost, mean_duration, num_constructions)
  print("PERFORMANCE:")
